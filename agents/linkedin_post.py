...
def generate_linkedin_posts(
    ...
    prompt = (
        ...
        f"- Be approximately 300 characters (200–400 is fine)\n"
        f"- Use line breaks between ideas, no walls of text\n"
        f"- Sound like a real person but also just go straight to the point\n"
        f"- Be concise, no harsh criticisms, sound interested but don't overdo enthusiasm"
        ...
        f"- No need for nitty gritty details, but still include deep enough technical concepts that recruiters understand\n"
        f"- No filler, no build up starting sentences\n"
        f"- No hashtags\n"
